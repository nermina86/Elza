...
private enum OutfitStore {
    static let equippedKey = "elsa.equippedNames.v1"
...
final class DressUpViewModel: ObservableObject {
    ...
    init() {
        self.catalog = [
            ...
            .init(name: "tshirt3", category: .top),
            .init(name: "jacket",  category: .top),
            .init(name: "jacket2",  category: .top),
            .init(name: "skirt",   category: .bottom),
            .init(name: "skirt1",   category: .bottom),
            .init(name: "skirt2",   category: .bottom),
            .init(name: "skirt3",   category: .bottom),
            .init(name: "shorts",  category: .bottom),
            .init(name: "shorts2", category: .bottom),
            .init(name: "shorts3", category: .bottom),
            .init(name: "shorts4", category: .bottom),
            .init(name: "hat1",    category: .hat),
            .init(name: "hat2",    category: .hat),
            .init(name: "hat3",    category: .hat),
            .init(name: "hair",    category: .hair),
            .init(name: "hair2",   category: .hair),
            .init(name: "hair3",   category: .hair),
            ...
            .init(name: "acc4",    category: .accessory)
        ]
...
struct ContentView: View {
    ...
    private func shareText() {
        ...
        let message = """
        Hey! Check out this ELZA dress-up app 👗✨
...
struct DollCanvas: View {
    ...
    var body: some View {
        GeometryReader { g in
            ZStack {
                LinearGradient(
                    colors: [Color.blue.opacity(0.8), Color.white.opacity(0.8)],
...
struct WardrobeColumn: View {
    ...
    var body: some View {
        ...
        .background(
            LinearGradient(
                colors: [Color.white.opacity(0.85), Color.blue.opacity(0.75)],
                startPoint: .topLeading,
                endPoint: .bottomTrailing
            )
        )
